...
(
    ...
    nome varchar(45),
    img varchar(100),
    CONSTRAINT pk_linguagem PRIMARY KEY (id),
    CONSTRAINT linguagem_nome_key UNIQUE (nome)
);	
/*
 insert into linguagem values
 (101 , 'C', './static/img/miniCardC.png'),
 (157 , 'CSS', './static/img/miniCardCSS.png'),
 (264 , 'C#', './static/img/miniCardCSharp.png'),
 (321 , 'C++', './static/img/miniCardC++.png'),
 (329 , 'HTML', './static/img/miniCardHTML.png'),
 (367 , 'Python', './static/img/miniCardPython.png'),
 (468 , 'Java', './static/img/miniCardJAVA2.png'),
 (532 , 'JavaScript', './static/img/miniCardJavaScript.png'),
...
(
    ...
    CONSTRAINT pk_gerenciatopico PRIMARY KEY (topico, colaborador),
    CONSTRAINT fk_gerenciatopico_colaborador FOREIGN KEY (colaborador)
        REFERENCES colaborador (id),
    CONSTRAINT fk_gerenciatopico_topico FOREIGN KEY (topico)
