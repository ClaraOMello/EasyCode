...
public class RequestUtil {
    ...
    public static String getQueryUsername(Request request) {
        return request.queryParamsValues("loginUsuario")[0];
    }

    public static String getQueryName(Request request) {
        return request.queryParamsValues("nome")[0];
    }
    public static String getQueryPassword(Request request) {
        return request.queryParamsValues("loginSenha")[0];
    }

    public static String getQueryLoginRedirect(Request request) {
        return request.queryParamsValues("loginRedirect")[0];
    }
